  ...
  return (
    <>
      <nav className="fixed top-0 left-0 right-0 z-50 bg-black text-white border-b border-zinc-900">
        ...
        {/* TOP BAR — 3-column layout: logo | links (center) | contact */}
        <div className="flex items-center justify-between px-4 sm:px-6 lg:px-8 py-3 min-h-[64px]">
            ...
            <div className="flex items-center gap-1 bg-zinc-900 rounded-full px-4 py-2">
              {navLinks.map((link) => (
                <button
                  ...
                  className={`px-5 py-2 rounded-full text-sm flex items-center gap-2 whitespace-nowrap transition-all duration-200 ${
          ...
          <div className="flex-shrink-0 flex items-center justify-end md:flex-1">
            {/* Desktop Contact */}
            <button
              onClick={handleContactClick}
              className="hidden md:flex border border-gray-700 hover:border-gray-400 text-white px-5 py-2.5 rounded-full text-sm items-center gap-2 hover:bg-zinc-900 transition-all"
            >
