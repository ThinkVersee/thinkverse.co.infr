...
const projects = [
    {
        ...
        heroImage: 'https://images.unsplash.com/photo-1485846234645-a62644f84728?w=800&q=80' // Professional casting dashboard mockup
    },
    {
        id: 2,
        ...
        heroImage: 'https://images.pexels.com/photos/4145190/pexels-photo-4145190.jpeg?auto=compress&cs=tinysrgb&w=800' // Clean education dashboard
    },
    {
        id: 5,
        ...
        heroImage: 'https://images.unsplash.com/photo-1544620347-c4fd4a3d5957?w=800&q=80'  // Bus fleet management dashboard
    },
];
    ...
    return (
        <section ref={sectionRef} className="py-20 lg:py-32 bg-blue-950 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
                ...
                <div className="pt-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-10">
                    {filteredProjects.map((project, index) => (
                        <Link href={`/projects/${project.slug}`} key={project.id} className="block h-full">
                            <div
                                className={`group relative bg-white rounded-3xl overflow-hidden border border-white/10 transition-all duration-700 hover:border-white/30 hover:shadow-2xl hover:shadow-blue-500/20 flex flex-col h-full cursor-pointer ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-16'}`}
                            ...
                            >
                                ...
                                <div className="p-6 lg:p-8 flex flex-col flex-grow">
                                    <h3 className="text-xl lg:text-2xl font-bold text-black mb-3 group-hover:text-blue-400 transition-colors line-clamp-2 min-h-[3.5rem]">
                                        {project.title}
                                    </h3>
